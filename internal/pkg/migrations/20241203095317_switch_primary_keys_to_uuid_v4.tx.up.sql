...
--
-- Create UUID PKs on link tables
--
...
--
-- Create UUID columns on link tables
--
ALTER TABLE l_aws_region_to_az
	...
	DROP COLUMN az_id,
	ADD COLUMN az_id UUID NOT NULL,
...
ALTER TABLE l_aws_region_to_vpc
	...
	DROP COLUMN vpc_id,
	ADD COLUMN vpc_id UUID NOT NULL,
...
ALTER TABLE l_aws_vpc_to_subnet
	...
	ADD COLUMN subnet_id UUID NOT NULL,
...
ALTER TABLE l_aws_instance_to_net_interface
	...
	DROP COLUMN ni_id,
	ADD COLUMN ni_id UUID NOT NULL,
...
ALTER TABLE l_aws_lb_to_vpc
	...
	DROP COLUMN lb_id,
	ADD COLUMN lb_id UUID NOT NULL,
...
ALTER TABLE l_g_shoot_to_project
	...
	ADD COLUMN shoot_id UUID NOT NULL,
...
ALTER TABLE l_g_shoot_to_seed
	...
	DROP COLUMN seed_id,
	ADD COLUMN seed_id UUID NOT NULL,
...
ALTER TABLE l_g_machine_to_shoot
	...
	ADD COLUMN machine_id UUID NOT NULL,
...
ALTER TABLE l_g_gcp_image_to_cloud_profile
	...
	ADD COLUMN gcp_image_id UUID NOT NULL,
...
ALTER TABLE l_g_azure_image_to_cloud_profile
	...
	ADD COLUMN azure_image_id UUID NOT NULL,
...
ALTER TABLE l_gcp_instance_to_nic
	...
	DROP COLUMN nic_id,
	ADD COLUMN nic_id UUID NOT NULL,
...
ALTER TABLE l_gcp_instance_to_disk
	...
	DROP COLUMN disk_id,
	ADD COLUMN disk_id UUID NOT NULL,
...
ALTER TABLE l_az_rg_to_subscription
	...
	DROP COLUMN rg_id,
	ADD COLUMN rg_id UUID NOT NULL,
	DROP CONSTRAINT l_az_rg_to_subscription_sub_id_fkey,
	DROP COLUMN sub_id,
	ADD COLUMN sub_id UUID NOT NULL,
...
ALTER TABLE l_az_vm_to_rg
	...
	DROP COLUMN vm_id,
	ADD COLUMN vm_id UUID NOT NULL,
...
ALTER TABLE l_az_pub_addr_to_rg
	...
	DROP COLUMN pa_id,
	ADD COLUMN pa_id UUID NOT NULL,
...
ALTER TABLE l_az_blob_container_to_rg
	...
	ADD COLUMN blob_container_id UUID NOT NULL,
...
--
-- Create UUID PKs on non-link tables
--
ALTER TABLE aws_az
	DROP COLUMN id,
	ADD COLUMN id UUID NOT NULL DEFAULT gen_random_uuid(),
